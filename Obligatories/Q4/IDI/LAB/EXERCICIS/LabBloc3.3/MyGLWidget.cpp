...
void MyGLWidget::modelTransformPatricio ()
{
  ...
  TG = glm::scale(TG, glm::vec3(escala/2*0.3, escala/2*0.3, escala/2*0.3));
...
void MyGLWidget::carregaShaders() {
  ...
  posFoc1 = glGetUniformLocation (program->programId(), "posFocus1");
  glUniform4fv(posFoc1,1,&rr1[0]);
  colorFoc = glGetUniformLocation (program->programId(), "colorFocus");
  glUniform3fv(colorFoc,1,&f[0]);
  camaras = glGetUniformLocation (program->programId(), "cam");
  glUniform1i(camaras,camara);
  escenes = glGetUniformLocation (program->programId(), "esc");
