...
public class Main {
    ...
    private static void guardarPrestatgerias() {
        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("prestatgerias.dat"))) {
            oos.writeObject(perfilActual.getPrestatgerias());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private static void cargarPrestatgerias() {
        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream("prestatgerias.dat"))) {
            perfilActual.setPrestatgerias((List<Prestatgeria>) ois.readObject());
        } catch (IOException | ClassNotFoundException e) {
            perfilActual.setPrestatgerias(new ArrayList<>());
        }
    }
    ...
    private static void crearDistribucionInicial() {
        ...
        int altura = prestatgeriaActual.getAltura();
