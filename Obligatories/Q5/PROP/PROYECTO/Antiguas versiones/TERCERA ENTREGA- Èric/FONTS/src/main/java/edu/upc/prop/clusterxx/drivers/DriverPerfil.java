...
public class DriverPerfil {
    ...
    private static void guardarDatos() {
        try {
            ...
            System.out.println("ERROR - No se pudo guardar los perfiles.");
            e.printStackTrace();
        }
    }
    ...
    private static void cargarDatos() {
        try {
            ...
            System.out.println("No se encontraron perfiles guardados. Se creará un nuevo conjunto de perfiles.");
