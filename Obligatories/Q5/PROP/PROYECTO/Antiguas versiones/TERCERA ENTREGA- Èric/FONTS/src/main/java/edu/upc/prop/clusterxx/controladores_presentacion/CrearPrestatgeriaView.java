    ...
    public CrearPrestatgeriaView(Presentacion_Main controller) {
        ...
        crearBtn.addActionListener(e -> {
            ...
            try {
                ...
                if (controller.getPrestatgeria().containsKey(nombre)) {
                    JOptionPane.showMessageDialog(controller, "La prestatgeria ya existe, elija otro nombre.");
                } else {
                    Prestatgeria prestatgeria = new Prestatgeria(nombre, altura);
                    controller.getPrestatgeria().put(nombre, new ControladorPrestatgeria(prestatgeria));
                    controller.getPerfilActual().getPrestatgerias().add(prestatgeria);
