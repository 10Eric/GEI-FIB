...
public class AplicacionDistribucionesPersistente extends JFrame {
    ...
    private void mostrarMenuDistribuciones() {
        ...
        JButton atrasBtn = new JButton("Atrás");
        JLabel perfilLabel = new JLabel("Perfil Actual: " + perfilActual.getUsuario());
        panel.add(perfilLabel, BorderLayout.NORTH);
        JButton salirBtn = new JButton("Salir");
        ...
        panel.add(atrasBtn);
        panel.add(salirBtn, BorderLayout.SOUTH);
            ...
            if (producto1 != null && producto2 != null) {
                ...
                try {
                    ...
                    if (nuevaSimilitud < 0 || nuevaSimilitud > 100) {
                        JOptionPane.showMessageDialog(this, "La similitud debe estar entre 0 y 100.");
                        return;
                    }
