...
public class New_Prestatgeria {
   //Atributos de la clase prestatgeria
    ...
    //Constructora
    public New_Prestatgeria(int numeroDePrestatges, int altura){
        this.numero_prestatges = numeroDePrestatges;
        this.altura = altura;
