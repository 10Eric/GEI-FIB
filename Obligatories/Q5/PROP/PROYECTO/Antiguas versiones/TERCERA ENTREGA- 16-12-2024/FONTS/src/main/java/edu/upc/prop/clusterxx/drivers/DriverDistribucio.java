...
public class DriverDistribucio {
    ...
    private static ControladorPersistenciaDistribucio controladorPersistenciaDistribucio;
...
///////////////////////////////
    ...
    private static void guardarDistribuciones() {
        try{
            controladorPersistenciaDistribucio.guardarDistribucioDriver(controladorDistribucio, "distribuciones.dat");
        }
        catch (IOException e) {
            System.out.println("ERROR - No se pudo guardar las distribuciones.");
            e.printStackTrace();
        }
    }
    ...
    private static void cargarDistribuciones() {
        try {
            controladorDistribucio = controladorPersistenciaDistribucio.cargarDistribucioDriver("distribuciones.dat");
        }
        catch (IOException | ClassNotFoundException e) {
            System.out.println("No se encontraron distribuciones guardadas. Se creará una nueva distribución.");
            e.printStackTrace();
        }
    }
