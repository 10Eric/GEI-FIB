...
class EditarPrestatgeriaView {
    ...
    public EditarPrestatgeriaView(Presentacion_Main controller) {
        ...
        if (controller.getPerfilActual().getPrestatgerias().isEmpty()) {
        ...
        if (seleccion != null) {
            controller.setPrestatgeriaActual(controller.getPrestatgeria().get(seleccion));
            ...
            if (opcion == JOptionPane.OK_OPTION) {
                ...
                controller.getPrestatgeria().put(controller.getPrestatgeriaActual().getNom(), controller.getPrestatgeriaActual());
