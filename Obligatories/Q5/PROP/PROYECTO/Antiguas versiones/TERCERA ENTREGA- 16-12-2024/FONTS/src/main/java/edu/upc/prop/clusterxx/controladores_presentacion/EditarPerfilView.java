    ...
    public EditarPerfilView(Presentacion_Main controller) {
        ...
        if (seleccion != null) {
            ...
            loginBtn.addActionListener(e -> {
                ...
                if (controller.getPerfiles().get(seleccion).getContrasenya().equals(contraseña)) {
                    ControladorPerfil controladorPerfil = controller.getPerfiles().get(seleccion);
                    JOptionPane.showMessageDialog(controller, "Contraseña correcta.");
                    controller.mostrarEditarPerfil(controladorPerfil);
                } else {
