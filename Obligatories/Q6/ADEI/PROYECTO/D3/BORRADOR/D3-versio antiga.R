...
names(dd)
boxplot(age ~ c2, data=dd, horizontal=TRUE, main="Edat per Clúster")
boxplot(hours_week ~ c2, data=dd, horizontal=TRUE, main="Hores setmanals per Clúster")
boxplot(edu_num ~ c2, data=dd, horizontal=TRUE, main="Guany capital per Clúster")
